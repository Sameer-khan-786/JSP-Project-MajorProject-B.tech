...
<%
    ...
    UserDao userDAO = new UserDao(ConnectionProvider.getConnection()); User user = new User(); user = userDAO.getUserByUserId((int) session.getAttribute("user_id")); 
    if (user == null) {
...
<html>
    <head>
        ...
        <title><%= p.getpTitle()%> || CHATTING HUB </title>
        ...
        <div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/en_GB/sdk.js#xfbml=1&version=v10.0" nonce="zBr5H7kg"></script>
            ...
            <div class="row my-4">
                ...
                <div class="col-md-8 offset-md-2">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header nav-bac text-white">
                        ...
                        <div class="card-footer nav-bac">
                            ...
                            <div class="card-footer">
                                ...
                                <div class="fb-comments" data-href="http://localhost:1313/CodeWithSameer/show_blog_page.jsp?post_id=<%= p.getPid() %>" data-width="" data-numposts="5"></div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header primary-backgroung text-white text-center">
                        <h5 class="modal-title" id="exampleModalLabel"> CodeWithSameer </h5>
